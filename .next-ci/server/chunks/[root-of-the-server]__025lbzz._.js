...
if(document.readyState==='loading'){document.addEventListener('DOMContentLoaded',add)}else{add()}})()</script>`}(a,s)+E),"mobile"!==n.platform||s||(E+=(o=!!n.snapshot,d=`<link rel="manifest" href="/api/apps/${a}/manifest.webmanifest">`,/name="theme-color"/i.test(e)||(d+='<meta name="theme-color" content="#0d0e1c">'),/apple-mobile-web-app-capable/i.test(e)||(d+='<meta name="apple-mobile-web-app-capable" content="yes"><meta name="apple-mobile-web-app-status-bar-style" content="black-translucent">'),o||(d+="<script>if('serviceWorker' in navigator){var p=location.pathname.replace(/\\/$/,'');navigator.serviceWorker.register(p+'/sw.js',{scope:p}).catch(function(){})}</script>"),d)),/<head[^>]*>/i.test(e)?e.replace(/<head([^>]*)>/i,`<head$1>${E}`):E+e}e.s(["exportAppHtml",0,function(e,t,a={}){return r(e,t,a,"https://quark-apps.lexarcai.com")},"notFoundApp",0,function(){return new Response("<h1>404</h1><p>这个应用不存在或已下线。</p>",{status:404,headers:{"content-type":"text/html; charset=utf-8"}})},"serveAppHtml",0,function(e,t,a={}){return new Response(r(e,t,a),{headers:{"content-type":"text/html; charset=utf-8","cache-control":"no-cache"}})}])},65931,e=>{"use strict";var t=e.i(47909),r=e.i(74017),a=e.i(96250),n=e.i(59756),s=e.i(61916),o=e.i(74677),i=e.i(69741),d=e.i(16795),E=e.i(87718),T=e.i(95169),p=e.i(47587),c=e.i(66012),l=e.i(70101),u=e.i(26937),N=e.i(10372),L=e.i(93695);e.i(20232);var m=e.i(220),R=e.i(43793),_=e.i(52035);async function f(e,t){let{name:r}=await t.params,a=R.db.prepare(`SELECT v.html, p.slug, p.platform, p.connectors FROM projects p
       JOIN app_versions v ON v.id = p.published_version_id
       WHERE p.domain_name = ? AND p.published_version_id IS NOT NULL`).get(r);return a?(0,_.serveAppHtml)(a.html,a.slug,{platform:"web",connectors:a.connectors}):(0,_.notFoundApp)()}e.s(["GET",0,f,"dynamic",0,"force-dynamic"],62200);var O=e.i(62200);let x=new t.AppRouteRouteModule({definition:{kind:r.RouteKind.APP_ROUTE,page:"/d/[name]/route",pathname:"/d/[name]",filename:"route",bundlePath:""},distDir:".next-ci",relativeProjectDir:"",resolvedPagePath:"[project]/src/app/d/[name]/route.ts",nextConfigOutput:"",userland:O,...{}}),{workAsyncStorage:A,workUnitAsyncStorage:I,serverHooks:b}=x;async function h(e,t,a){a.requestMeta&&(0,n.setRequestMeta)(e,a.requestMeta),x.isDev&&(0,n.addRequestMeta)(e,"devRequestTimingInternalsEnd",process.hrtime.bigint());let R="/d/[name]/route";R=R.replace(/\/index$/,"")||"/";let _=await x.prepare(e,t,{srcPage:R,multiZoneDraftMode:!1});if(!_)return t.statusCode=400,t.end("Bad Request"),null==a.waitUntil||a.waitUntil.call(a,Promise.resolve()),null;let{buildId:f,deploymentId:O,params:A,nextConfig:I,parsedUrl:b,isDraftMode:h,prerenderManifest:v,routerServerContext:C,isOnDemandRevalidate:S,revalidateOnlyGenerated:U,resolvedPathname:g,clientReferenceManifest:X,serverActionsManifest:y}=_,w=(0,i.normalizeAppPath)(R),j=!!(v.dynamicRoutes[w]||v.routes[g]),D=async()=>((null==C?void 0:C.render404)?await C.render404(e,t,b,!1):t.end("This page could not be found"),null);if(j&&!h){let e=!!v.routes[g],t=v.dynamicRoutes[w];if(t&&!1===t.fallback&&!e){if(I.adapterPath)return await D();throw new L.NoFallbackError}}let k=null;!j||x.isDev||h||(k="/index"===(k=g)?"/":k);let F=!0===x.isDev||!j,q=j&&!F;y&&X&&(0,o.setManifestsSingleton)({page:R,clientReferenceManifest:X,serverActionsManifest:y});let M=e.method||"GET",P=(0,s.getTracer)(),G=P.getActiveScopeSpan(),H=!!(null==C?void 0:C.isWrappedByNextServer),K=!!(0,n.getRequestMeta)(e,"minimalMode"),Y=(0,n.getRequestMeta)(e,"incrementalCache")||await x.getIncrementalCache(e,I,v,K);null==Y||Y.resetRequestCache(),globalThis.__incrementalCache=Y;let B={params:A,previewProps:v.preview,renderOpts:{experimental:{authInterrupts:!!I.experimental.authInterrupts},cacheComponents:!!I.cacheComponents,supportsDynamicResponse:F,incrementalCache:Y,cacheLifeProfiles:I.cacheLife,waitUntil:a.waitUntil,onClose:e=>{t.on("close",e)},onAfterTaskError:void 0,onInstrumentationRequestError:(t,r,a,n)=>x.onRequestError(e,t,a,n,C)},sharedContext:{buildId:f,deploymentId:O}},$=new d.NodeNextRequest(e),W=new d.NodeNextResponse(t),z=E.NextRequestAdapter.fromNodeNextRequest($,(0,E.signalFromNodeResponse)(t));try{let n,o=async e=>x.handle(z,B).finally(()=>{if(!e)return;e.setAttributes({"http.status_code":t.statusCode,"next.rsc":!1});let r=P.getRootSpanAttributes();if(!r)return;if(r.get("next.span_type")!==T.BaseServerSpan.handleRequest)return void console.warn(`Unexpected root span type '${r.get("next.span_type")}'. Please report this Next.js issue https://github.com/vercel/next.js`);let a=r.get("next.route");if(a){let t=`${M} ${a}`;e.setAttributes({"next.route":a,"http.route":a,"next.span_name":t}),e.updateName(t),n&&n!==e&&(n.setAttribute("http.route",a),n.updateName(t))}else e.updateName(`${M} ${R}`)}),i=async n=>{var s,i;let d=async({previousCacheEntry:r})=>{try{if(!K&&S&&U&&!r)return t.statusCode=404,t.setHeader("x-nextjs-cache","REVALIDATED"),t.end("This page could not be found"),null;let s=await o(n);e.fetchMetrics=B.renderOpts.fetchMetrics;let i=B.renderOpts.pendingWaitUntil;i&&a.waitUntil&&(a.waitUntil(i),i=void 0);let d=B.renderOpts.collectedTags;if(!j)return await (0,c.sendResponse)($,W,s,B.renderOpts.pendingWaitUntil),null;{let e=await s.blob(),t=(0,l.toNodeOutgoingHttpHeaders)(s.headers);d&&(t[N.NEXT_CACHE_TAGS_HEADER]=d),!t["content-type"]&&e.type&&(t["content-type"]=e.type);let r=void 0!==B.renderOpts.collectedRevalidate&&!(B.renderOpts.collectedRevalidate>=N.INFINITE_CACHE)&&B.renderOpts.collectedRevalidate,a=void 0===B.renderOpts.collectedExpire||B.renderOpts.collectedExpire>=N.INFINITE_CACHE?void 0:B.renderOpts.collectedExpire;return{value:{kind:m.CachedRouteKind.APP_ROUTE,status:s.status,body:Buffer.from(await e.arrayBuffer()),headers:t},cacheControl:{revalidate:r,expire:a}}}}catch(t){throw(null==r?void 0:r.isStale)&&await x.onRequestError(e,t,{routerKind:"App Router",routePath:R,routeType:"route",revalidateReason:(0,p.getRevalidateReason)({isStaticGeneration:q,isOnDemandRevalidate:S})},!1,C),t}},E=await x.handleResponse({req:e,nextConfig:I,cacheKey:k,routeKind:r.RouteKind.APP_ROUTE,isFallback:!1,prerenderManifest:v,isRoutePPREnabled:!1,isOnDemandRevalidate:S,revalidateOnlyGenerated:U,responseGenerator:d,waitUntil:a.waitUntil,isMinimalMode:K});if(!j)return null;if((null==E||null==(s=E.value)?void 0:s.kind)!==m.CachedRouteKind.APP_ROUTE)throw Object.defineProperty(Error(`Invariant: app-route received invalid cache entry ${null==E||null==(i=E.value)?void 0:i.kind}`),"__NEXT_ERROR_CODE",{value:"E701",enumerable:!1,configurable:!0});K||t.setHeader("x-nextjs-cache",S?"REVALIDATED":E.isMiss?"MISS":E.isStale?"STALE":"HIT"),h&&t.setHeader("Cache-Control","private, no-cache, no-store, max-age=0, must-revalidate");let T=(0,l.fromNodeOutgoingHttpHeaders)(E.value.headers);return K&&j||T.delete(N.NEXT_CACHE_TAGS_HEADER),!E.cacheControl||t.getHeader("Cache-Control")||T.get("Cache-Control")||T.set("Cache-Control",(0,u.getCacheControlHeader)(E.cacheControl)),await (0,c.sendResponse)($,W,new Response(E.value.body,{headers:T,status:E.value.status||200})),null};H&&G?await i(G):(n=P.getActiveScopeSpan(),await P.withPropagatedContext(e.headers,()=>P.trace(T.BaseServerSpan.handleRequest,{spanName:`${M} ${R}`,kind:s.SpanKind.SERVER,attributes:{"http.method":M,"http.target":e.url}},i),void 0,!H))}catch(t){if(t instanceof L.NoFallbackError||await x.onRequestError(e,t,{routerKind:"App Router",routePath:w,routeType:"route",revalidateReason:(0,p.getRevalidateReason)({isStaticGeneration:q,isOnDemandRevalidate:S})},!1,C),j)throw t;return await (0,c.sendResponse)($,W,new Response(null,{status:500})),null}}e.s(["handler",0,h,"patchFetch",0,function(){return(0,a.patchFetch)({workAsyncStorage:A,workUnitAsyncStorage:I})},"routeModule",0,x,"serverHooks",0,b,"workAsyncStorage",0,A,"workUnitAsyncStorage",0,I],65931)}];

//# sourceMappingURL=%5Broot-of-the-server%5D__025lbzz._.js.map