module.exports=[18622,(e,t,r)=>{t.exports=e.x("next/dist/compiled/next-server/app-page-turbo.runtime.prod.js",()=>require("next/dist/compiled/next-server/app-page-turbo.runtime.prod.js"))},56704,(e,t,r)=>{t.exports=e.x("next/dist/server/app-render/work-async-storage.external.js",()=>require("next/dist/server/app-render/work-async-storage.external.js"))},32319,(e,t,r)=>{t.exports=e.x("next/dist/server/app-render/work-unit-async-storage.external.js",()=>require("next/dist/server/app-render/work-unit-async-storage.external.js"))},24725,(e,t,r)=>{t.exports=e.x("next/dist/server/app-render/after-task-async-storage.external.js",()=>require("next/dist/server/app-render/after-task-async-storage.external.js"))},70406,(e,t,r)=>{t.exports=e.x("next/dist/compiled/@opentelemetry/api",()=>require("next/dist/compiled/@opentelemetry/api"))},93695,(e,t,r)=>{t.exports=e.x("next/dist/shared/lib/no-fallback-error.external.js",()=>require("next/dist/shared/lib/no-fallback-error.external.js"))},66680,(e,t,r)=>{t.exports=e.x("node:crypto",()=>require("node:crypto"))},2157,(e,t,r)=>{t.exports=e.x("node:fs",()=>require("node:fs"))},50227,(e,t,r)=>{t.exports=e.x("node:path",()=>require("node:path"))},43793,e=>{"use strict";let t,r;var a,s=e.x("node:sqlite",()=>require("node:sqlite"),!0),E=e.i(66680),i=e.i(2157),n=e.i(50227);let T=process.env.DATA_DIR||n.default.join(process.cwd(),"data");function o(e,t,r,a){e.prepare(`PRAGMA table_info(${t})`).all().some(e=>e.name===r)||e.exec(`ALTER TABLE ${t} ADD COLUMN ${a}`)}let d=globalThis,N=d.__quarkDb??(i.default.mkdirSync(T,{recursive:!0}),(t=new s.DatabaseSync(n.default.join(T,"quark.db"))).exec("PRAGMA busy_timeout = 5000"),t.exec(`
  ...
  `),function(e){let t=e.prepare(`SELECT p.id AS project_id, p.published_version_id AS version_id, v.prompt
       ...
       WHERE p.published_version_id IS NOT NULL
         AND NOT EXISTS (SELECT 1 FROM artifacts a WHERE a.project_id = p.id)`).all(),r=e.prepare("INSERT INTO artifacts (id, project_id, version_id, seq, notes, created_at) VALUES (?, ?, ?, 1, ?, ?)");for(let e of t)r.run(`a_${(0,E.randomBytes)(9).toString("base64url")}`,e.project_id,e.version_id,e.prompt,Date.now())}(t),d.__quarkDb=t);e.s(["db",0,N,"now",0,function(){return Date.now()}])},95012,e=>{"use strict";var t=e.i(43793);e.s(["ownedProject",0,function(e,r){return t.db.prepare("SELECT * FROM projects WHERE id = ? AND user_id = ?").get(r,e)}])},83159,e=>{"use strict";var t=e.i(43793);let r=new Set(["text/plain","text/markdown","text/csv","application/json"]),a=new Set(["image/png","image/jpeg","image/webp","image/svg+xml"]);function s(e){return r.has(e)?"text":a.has(e)?"image":null}e.s(["attachmentKind",0,s,"inlineImageAssets",0,function(e,t){let r=e;for(let e of t)"image"===e.kind&&e.dataUri&&(r=r.split(`asset://${e.filename}`).join(e.dataUri));return r},"listAttachments",0,function(e){return t.db.prepare("SELECT id, filename, mime, kind, size FROM attachments WHERE project_id = ? ORDER BY created_at").all(e).map(e=>({...e}))},"loadPipelineAttachments",0,function(e){return t.db.prepare("SELECT filename, mime, kind, data FROM attachments WHERE project_id = ? ORDER BY created_at").all(e).map(e=>{let t=Buffer.from(e.data);return"text"===e.kind?{filename:e.filename,kind:e.kind,mime:e.mime,text:t.toString("utf8")}:{filename:e.filename,kind:e.kind,mime:e.mime,dataUri:`data:${e.mime};base64,${t.toString("base64")}`}})},"validateAttachment",0,function(e,t,r){let a=s(e);if(!a)return"仅支持文本(txt/md/csv/json)与图片(png/jpg/webp/svg)";if(r>=6)return"每个项目最多 6 个附件";let E="text"===a?65536:524288;return t>E?`${"text"===a?"文本":"图片"}附件不能超过 ${E/1024}KB`:0===t?"文件为空":null}])},59400,e=>{"use strict";var t=e.i(47909),r=e.i(74017),a=e.i(96250),s=e.i(59756),E=e.i(61916),i=e.i(74677),n=e.i(69741),T=e.i(16795),o=e.i(87718),d=e.i(95169),N=e.i(47587),p=e.i(66012),l=e.i(70101),c=e.i(26937),u=e.i(10372),L=e.i(93695);e.i(20232);var R=e.i(220),_=e.i(89171),m=e.i(43793),O=e.i(79832),A=e.i(95012),I=e.i(83159);async function U(e,t){let r=await (0,O.getUser)();if(!r)return _.NextResponse.json({error:"未登录"},{status:401});let a=(0,O.demoGuard)(r);if(a)return _.NextResponse.json({error:a},{status:403});let{id:s,attId:E}=await t.params;return(0,A.ownedProject)(r.id,s)?(m.db.prepare("DELETE FROM attachments WHERE id = ? AND project_id = ?").run(E,s),_.NextResponse.json({ok:!0,attachments:(0,I.listAttachments)(s)})):_.NextResponse.json({error:"项目不存在"},{status:404})}e.s(["DELETE",0,U],36225);var C=e.i(36225);let X=new t.AppRouteRouteModule({definition:{kind:r.RouteKind.APP_ROUTE,page:"/api/projects/[id]/attachments/[attId]/route",pathname:"/api/projects/[id]/attachments/[attId]",filename:"route",bundlePath:""},distDir:".next-ci",relativeProjectDir:"",resolvedPagePath:"[project]/src/app/api/projects/[id]/attachments/[attId]/route.ts",nextConfigOutput:"",userland:C,...{}}),{workAsyncStorage:S,workUnitAsyncStorage:x,serverHooks:h}=X;async function f(e,t,a){a.requestMeta&&(0,s.setRequestMeta)(e,a.requestMeta),X.isDev&&(0,s.addRequestMeta)(e,"devRequestTimingInternalsEnd",process.hrtime.bigint());let _="/api/projects/[id]/attachments/[attId]/route";_=_.replace(/\/index$/,"")||"/";let m=await X.prepare(e,t,{srcPage:_,multiZoneDraftMode:!1});if(!m)return t.statusCode=400,t.end("Bad Request"),null==a.waitUntil||a.waitUntil.call(a,Promise.resolve()),null;let{buildId:O,deploymentId:A,params:I,nextConfig:U,parsedUrl:C,isDraftMode:S,prerenderManifest:x,routerServerContext:h,isOnDemandRevalidate:f,revalidateOnlyGenerated:v,resolvedPathname:j,clientReferenceManifest:g,serverActionsManifest:D}=m,F=(0,n.normalizeAppPath)(_),w=!!(x.dynamicRoutes[F]||x.routes[j]),b=async()=>((null==h?void 0:h.render404)?await h.render404(e,t,C,!1):t.end("This page could not be found"),null);if(w&&!S){let e=!!x.routes[j],t=x.dynamicRoutes[F];if(t&&!1===t.fallback&&!e){if(U.adapterPath)return await b();throw new L.NoFallbackError}}let y=null;!w||X.isDev||S||(y="/index"===(y=j)?"/":y);let k=!0===X.isDev||!w,P=w&&!k;D&&g&&(0,i.setManifestsSingleton)({page:_,clientReferenceManifest:g,serverActionsManifest:D});let M=e.method||"GET",G=(0,E.getTracer)(),q=G.getActiveScopeSpan(),H=!!(null==h?void 0:h.isWrappedByNextServer),K=!!(0,s.getRequestMeta)(e,"minimalMode"),B=(0,s.getRequestMeta)(e,"incrementalCache")||await X.getIncrementalCache(e,U,x,K);null==B||B.resetRequestCache(),globalThis.__incrementalCache=B;let Y={params:I,previewProps:x.preview,renderOpts:{experimental:{authInterrupts:!!U.experimental.authInterrupts},cacheComponents:!!U.cacheComponents,supportsDynamicResponse:k,incrementalCache:B,cacheLifeProfiles:U.cacheLife,waitUntil:a.waitUntil,onClose:e=>{t.on("close",e)},onAfterTaskError:void 0,onInstrumentationRequestError:(t,r,a,s)=>X.onRequestError(e,t,a,s,h)},sharedContext:{buildId:O,deploymentId:A}},$=new T.NodeNextRequest(e),W=new T.NodeNextResponse(t),Q=o.NextRequestAdapter.fromNodeNextRequest($,(0,o.signalFromNodeResponse)(t));try{let s,i=async e=>X.handle(Q,Y).finally(()=>{if(!e)return;e.setAttributes({"http.status_code":t.statusCode,"next.rsc":!1});let r=G.getRootSpanAttributes();if(!r)return;if(r.get("next.span_type")!==d.BaseServerSpan.handleRequest)return void console.warn(`Unexpected root span type '${r.get("next.span_type")}'. Please report this Next.js issue https://github.com/vercel/next.js`);let a=r.get("next.route");if(a){let t=`${M} ${a}`;e.setAttributes({"next.route":a,"http.route":a,"next.span_name":t}),e.updateName(t),s&&s!==e&&(s.setAttribute("http.route",a),s.updateName(t))}else e.updateName(`${M} ${_}`)}),n=async s=>{var E,n;let T=async({previousCacheEntry:r})=>{try{if(!K&&f&&v&&!r)return t.statusCode=404,t.setHeader("x-nextjs-cache","REVALIDATED"),t.end("This page could not be found"),null;let E=await i(s);e.fetchMetrics=Y.renderOpts.fetchMetrics;let n=Y.renderOpts.pendingWaitUntil;n&&a.waitUntil&&(a.waitUntil(n),n=void 0);let T=Y.renderOpts.collectedTags;if(!w)return await (0,p.sendResponse)($,W,E,Y.renderOpts.pendingWaitUntil),null;{let e=await E.blob(),t=(0,l.toNodeOutgoingHttpHeaders)(E.headers);T&&(t[u.NEXT_CACHE_TAGS_HEADER]=T),!t["content-type"]&&e.type&&(t["content-type"]=e.type);let r=void 0!==Y.renderOpts.collectedRevalidate&&!(Y.renderOpts.collectedRevalidate>=u.INFINITE_CACHE)&&Y.renderOpts.collectedRevalidate,a=void 0===Y.renderOpts.collectedExpire||Y.renderOpts.collectedExpire>=u.INFINITE_CACHE?void 0:Y.renderOpts.collectedExpire;return{value:{kind:R.CachedRouteKind.APP_ROUTE,status:E.status,body:Buffer.from(await e.arrayBuffer()),headers:t},cacheControl:{revalidate:r,expire:a}}}}catch(t){throw(null==r?void 0:r.isStale)&&await X.onRequestError(e,t,{routerKind:"App Router",routePath:_,routeType:"route",revalidateReason:(0,N.getRevalidateReason)({isStaticGeneration:P,isOnDemandRevalidate:f})},!1,h),t}},o=await X.handleResponse({req:e,nextConfig:U,cacheKey:y,routeKind:r.RouteKind.APP_ROUTE,isFallback:!1,prerenderManifest:x,isRoutePPREnabled:!1,isOnDemandRevalidate:f,revalidateOnlyGenerated:v,responseGenerator:T,waitUntil:a.waitUntil,isMinimalMode:K});if(!w)return null;if((null==o||null==(E=o.value)?void 0:E.kind)!==R.CachedRouteKind.APP_ROUTE)throw Object.defineProperty(Error(`Invariant: app-route received invalid cache entry ${null==o||null==(n=o.value)?void 0:n.kind}`),"__NEXT_ERROR_CODE",{value:"E701",enumerable:!1,configurable:!0});K||t.setHeader("x-nextjs-cache",f?"REVALIDATED":o.isMiss?"MISS":o.isStale?"STALE":"HIT"),S&&t.setHeader("Cache-Control","private, no-cache, no-store, max-age=0, must-revalidate");let d=(0,l.fromNodeOutgoingHttpHeaders)(o.value.headers);return K&&w||d.delete(u.NEXT_CACHE_TAGS_HEADER),!o.cacheControl||t.getHeader("Cache-Control")||d.get("Cache-Control")||d.set("Cache-Control",(0,c.getCacheControlHeader)(o.cacheControl)),await (0,p.sendResponse)($,W,new Response(o.value.body,{headers:d,status:o.value.status||200})),null};H&&q?await n(q):(s=G.getActiveScopeSpan(),await G.withPropagatedContext(e.headers,()=>G.trace(d.BaseServerSpan.handleRequest,{spanName:`${M} ${_}`,kind:E.SpanKind.SERVER,attributes:{"http.method":M,"http.target":e.url}},n),void 0,!H))}catch(t){if(t instanceof L.NoFallbackError||await X.onRequestError(e,t,{routerKind:"App Router",routePath:F,routeType:"route",revalidateReason:(0,N.getRevalidateReason)({isStaticGeneration:P,isOnDemandRevalidate:f})},!1,h),w)throw t;return await (0,p.sendResponse)($,W,new Response(null,{status:500})),null}}e.s(["handler",0,f,"patchFetch",0,function(){return(0,a.patchFetch)({workAsyncStorage:S,workUnitAsyncStorage:x})},"routeModule",0,X,"serverHooks",0,h,"workAsyncStorage",0,S,"workUnitAsyncStorage",0,x],59400)}];

//# sourceMappingURL=%5Broot-of-the-server%5D__12rq19o._.js.map